package com.sportslightadmin.board.dto;
...
import com.sportslightadmin.members.dto.MembersDTO;

//import members.dto.MembersDTO;


@Component // 롬복을 이용해서 할거면 컴포넌트 어노테이션은 필요없다.
public class BoardDTO {
	...
	private String upload; // 첨부파일 작업, 보드 파일을 처리하는 멤버변수

	// form 페이지에서 파일첨부를 받아 처리해주는 멤버변수
	private MultipartFile filename; // 멀티파일로 내보내줌, form에 입력되어 있는 타입을 선언하면 됨?
